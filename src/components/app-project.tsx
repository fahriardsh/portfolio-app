...
export function Project() {
    ...
    return (
        <div className="py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 extended-lg:grid-cols-3 2xl:grid-cols-4 lg:px-20 xl:px-40 gap-x-10 gap-y-10 w-full flex items-center justify-center">
